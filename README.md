...
rossmann_stores_sarimax.ipynb trains one model for each store in the dataset, resulting in a runtime of approximately 1 hour and thirty minutes when parallelized on an Macbook M4 Pro. Please beware.
